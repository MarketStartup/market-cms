...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_course_listing" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_course_detail" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_course_listing" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_course_detail" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "pages_blocks_course_listing" ADD CONSTRAINT "pages_blocks_course_listing_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_course_detail" ADD CONSTRAINT "pages_blocks_course_detail_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_course_listing" ADD CONSTRAINT "_pages_v_blocks_course_listing_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_course_detail" ADD CONSTRAINT "_pages_v_blocks_course_detail_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_course_listing_order_idx" ON "pages_blocks_course_listing" USING btree ("_order");
  CREATE INDEX "pages_blocks_course_listing_parent_id_idx" ON "pages_blocks_course_listing" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_course_listing_path_idx" ON "pages_blocks_course_listing" USING btree ("_path");
  CREATE INDEX "pages_blocks_course_detail_order_idx" ON "pages_blocks_course_detail" USING btree ("_order");
  CREATE INDEX "pages_blocks_course_detail_parent_id_idx" ON "pages_blocks_course_detail" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_course_detail_path_idx" ON "pages_blocks_course_detail" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_course_listing_order_idx" ON "_pages_v_blocks_course_listing" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_course_listing_parent_id_idx" ON "_pages_v_blocks_course_listing" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_course_listing_path_idx" ON "_pages_v_blocks_course_listing" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_course_detail_order_idx" ON "_pages_v_blocks_course_detail" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_course_detail_parent_id_idx" ON "_pages_v_blocks_course_detail" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_course_detail_path_idx" ON "_pages_v_blocks_course_detail" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_course_listing" CASCADE;
  DROP TABLE "pages_blocks_course_detail" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_course_listing" CASCADE;
  DROP TABLE "_pages_v_blocks_course_detail" CASCADE;
